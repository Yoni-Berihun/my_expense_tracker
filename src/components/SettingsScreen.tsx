      ...
      <div className="glass-card" style={{ padding: '20px 24px' }}>
        ...
        {!isSupabaseConfigured ? (
          ...
          <div style={{ textAlign: 'center' }}>
            <p className="text-muted" style={{ marginBottom: '20px' }}>Sign in to synchronize your expenses securely to the cloud and prevent local data loss.</p>
            <button className="btn-gold" style={{ width: '100%' }} onClick={() => handleSocialLogin('github')}>
              Sign In with GitHub
            </button>
          </div>
        )}
